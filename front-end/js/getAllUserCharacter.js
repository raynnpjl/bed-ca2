        ...
        displayItem.innerHTML = `
            <img src="img/${character.character_class}.webp" alt="${character.character_class}.webp">
                    <div class="details">
                        ...
                        <div class="title">
                            <button id="${character.character_name}" onclick = "levelUpCharacter(this.id)">Level Up</button>
                            <button id="${character.character_name}" onclick = "evolvePet(this.id)">Evolve Pet</button>
                            <button id="${character.character_name}" onclick = "deleteCharacter(this.id)">Delete</button>
                        ...
                        <button id="${character.character_name}" onclick = "unEquip(this.id)">Unequip</button>
                </div>
                `
